    ...
    class Webyx_FE {
      ...
      public function webyx_fe_frontend_section_before_render ( \Elementor\Element_Base $element ) {
        ...
        if ( $webyx_fe_is_enable && 'on' === $webyx_section_enable && '' === $webyx_section_hide_in_frontend && ! $is_inner ) {
          ...
          if ( $ws_type === 'front' ) {
            ...
            echo '<div class="webyx-stripe" data-stripe="' . esc_attr( $ws_name ) . '" ' . esc_attr( $data_continuous_carousel ) . '>';
      ...
      public function webyx_fe_print_na_css_validated ( $ps ) {
        ...
        if ( 'on' === $av ) {
          ...
          $mvnaac = isset( $ps[ 'mvnaac' ] ) && $this->webyx_fe_sanitize_hex_color( $ps[ 'mvnaac' ] ) ? $ps[ 'mvnaac' ] : '#00000066'; 
          $mvnac = isset( $ps[ 'mvnac' ] ) && $this->webyx_fe_sanitize_hex_color( $ps[ 'mvnac' ] )  ? $ps[ 'mvnac' ] : '#000000';   
          $mvnacl = isset( $ps[ 'mvnacl' ] ) && $this->webyx_fe_sanitize_hex_color( $ps[ 'mvnacl' ] ) ? $ps[ 'mvnacl' ] : '#00000066';
      ...
      public function webyx_fe_print_nb_css_validated ( $ps ) {
        ...
        $mvndc = isset( $ps[ 'mvndc' ] ) && $this->webyx_fe_sanitize_hex_color( $ps[ 'mvndc' ] ) ? $ps[ 'mvndc' ] : '#000000';       
        $mvndcl = isset( $ps[ 'mvndcl' ] ) && $this->webyx_fe_sanitize_hex_color( $ps[ 'mvndcl' ] ) ? $ps[ 'mvndcl' ] : '#00000066';     
        $dbkgace = isset( $ps[ 'dbkgace' ] ) && in_array( $ps[ 'dbkgace' ], array( 'on', '' ), true ) ? $ps[ 'dbkgace' ] : '';                    
        $dbkgac = isset( $ps[ 'dbkgac' ] ) && $this->webyx_fe_sanitize_hex_color( $ps[ 'dbkgac' ] ) ? $ps[ 'dbkgac' ] : '#00000066';     
        $mvndttace = isset( $ps[ 'mvndttace' ] ) && in_array( $ps[ 'mvndttace' ], array( 'on', '' ), true ) ? $ps[ 'mvndttace' ] : '';                    
        $mvndttac = isset( $ps[ 'mvndttac' ] ) && $this->webyx_fe_sanitize_hex_color( $ps[ 'mvndttac' ] ) ? $ps[ 'mvndttac' ] : '#ffffff'; 
        ...
        $mvndttc = isset( $ps[ 'mvndttc' ] ) && $this->webyx_fe_sanitize_hex_color( $ps[ 'mvndttc' ] )  ? $ps[ 'mvndttc' ] : '#000000';               
        $mvndttcl = isset( $ps[ 'mvndttcl' ] ) && $this->webyx_fe_sanitize_hex_color( $ps[ 'mvndttcl' ] ) ? $ps[ 'mvndttcl' ] : '#00000066';           
        switch ( $mvndbst ) { 
          case 'scale':
      ...
      public function webyx_fe_print_imwh_css_validated ( $ps ) {
        ...
        $body = '';
        if ( 'on' === $nvvw && 'on' === $avvd ) {
          $msiwc = isset( $ps[ 'msiwc' ] ) && $this->webyx_fe_sanitize_hex_color( $ps[ 'msiwc' ] ) ? $ps[ 'msiwc'   ] : '#000000';                      
          $msiwbce = isset( $ps[ 'msiwbce' ] ) && in_array( $ps[ 'msiwbce' ], array( 'on', '' ), true ) ? $ps[ 'msiwbce' ] : '';                                   
          $msiwbc = isset( $ps[ 'msiwbc'  ] ) && $this->webyx_fe_sanitize_hex_color( $ps[ 'msiwbc' ] ) ? $ps[ 'msiwbc'  ] : '#ffffff';                
          if ( 'on' === $msiwbce ) {
      ...
      public function webyx_fe_print_fs_css_validated ( $ps ) {
        ...
        $body = '';
        if ( 'on' === $fsb ) {
          $fsc = isset( $ps[ 'fsc' ] ) && $this->webyx_fe_sanitize_hex_color( $ps[ 'fsc' ] ) ? $ps[ 'fsc' ] : '#000000'; 
          ...
          if ( 'on' === $fsbce ) {
            $fsbc = isset( $ps[ 'fsbc' ] ) && $this->webyx_fe_sanitize_hex_color( $ps[ 'fsbc' ] ) ? $ps[ 'fsbc' ] : '#ffffff00';
      ...
      public function webyx_fe_get_splash_screen_validated ( $ps ) {
        ...
        $ilsbc = isset( $ps[ 'ilsbc'  ] ) && $this->webyx_fe_sanitize_hex_color( $ps[ 'ilsbc'  ] ) ? $ps[ 'ilsbc'  ] : '#9933CC'; 
        $ilssbc = isset( $ps[ 'ilssbc' ] ) && $this->webyx_fe_sanitize_hex_color( $ps[ 'ilssbc' ] ) ? $ps[ 'ilssbc' ] : '#FFFFFF';
        $ilscmt = isset( $ps[ 'ilscmt' ] ) && 'string' === gettype( $ps[ 'ilscmt' ] ) ? $ps[ 'ilscmt' ] : '';
        $ilscmtc = isset( $ps[ 'ilscmtc' ] ) && $this->webyx_fe_sanitize_hex_color( $ps[ 'ilscmtc' ] ) ? $ps[ 'ilscmtc' ] : '#000000';
        $ilscbc = isset( $ps[ 'ilscbc' ] ) && $this->webyx_fe_sanitize_hex_color( $ps[ 'ilscbc' ] ) ? $ps[ 'ilscbc' ] : '#FFFFFF';
      ...
      public function webyx_fe_get_bkg_css_rules_validated ( $s, $ps, $cn_bkg, $cn_wrp_cnt ) {
        ...
        if ( 'on' === $ws_bkg ) {
          ...
          if ( isset( $section_background_image_url[ 'url' ] ) && '' !== $section_background_image_url[ 'url' ] ) {
            ...
            $ws_bkg_colour = isset( $s[ 'webyx_section_background_colour' ] ) && $this->webyx_fe_sanitize_hex_color( $s[ 'webyx_section_background_colour' ] ) ? $s[ 'webyx_section_background_colour' ] : '#ffffff';
